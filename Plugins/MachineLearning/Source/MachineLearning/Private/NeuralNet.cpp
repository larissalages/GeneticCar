...
int32 ANeuralNet::getNumLayers() const
{
    return NeurologicalLayers.Num();
}
int32 ANeuralNet::getLayerSize(int32 layer) const
{
    return NeurologicalLayers[layer].Num() - 1;
}

UNeuron& ANeuralNet::GetNeuron(int32 layer, int32 index)
{
    return NeurologicalLayers[layer][index];
}
